...
- Version: 1.0
- Scope: app SDK integration across PC React, H5 mobile React, Flutter, mini program, uni-app, Unity, static web, native Android, native iOS, native HarmonyOS, desktop/native, Rust-enabled apps, Drive Uploader, app dependency composition, appbase IAM runtime, and global token-manager wiring
