...
//
// Usage:
//   node sync-agent-dependency-standard.mjs --workspace <workspace-root> --check
//   node sync-agent-dependency-standard.mjs --workspace <workspace-root> --apply
//   node sync-agent-dependency-standard.mjs --root <workspace-root>/sdkwork-order --apply
//
