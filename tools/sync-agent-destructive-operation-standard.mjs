...
//
// Usage:
//   node sync-agent-destructive-operation-standard.mjs --workspace <workspace-root> --check
//   node sync-agent-destructive-operation-standard.mjs --workspace <workspace-root> --apply
//   node sync-agent-destructive-operation-standard.mjs --root <workspace-root>/sdkwork-order --apply
//   node sync-agent-destructive-operation-standard.mjs --workspace <workspace-root> --recursive --check
//
